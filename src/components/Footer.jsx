        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="mb-6">
                <h3 className="text-3xl font-bold bg-gradient-to-r from-white via-purple-200 to-purple-400 bg-clip-text text-transparent mb-4">
                  Lakshya Asthana
                </h3>
              ...
              <div className="space-y-3">
                {quickLinks.map((link, index) => (
                  <button
                    ...
                    className="block text-gray-400 hover:text-purple-300 transition-colors duration-300 text-left"
                  >
                    {link.name}
                  </button>
                ))}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {skills.map((skill, index) => (
                  <span
                    key={index}
                    className="px-3 py-1 bg-white/5 text-purple-300 rounded-full text-sm border border-purple-500/20 hover:bg-purple-500/10 transition-colors"
                  >
                    {skill}
                  </span>
                ))}
          ...
          <div className="max-w-7xl mx-auto px-6 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex items-center gap-6">
                ...
                <button
                  onClick={scrollToTop}
                  className="group p-2 bg-white/5 backdrop-blur-sm rounded-full border border-white/10 hover:border-purple-400/30 transition-all duration-300 hover:scale-110"
                  aria-label="Scroll to top"
                >
                  <ArrowUp size={16} className="text-gray-400 group-hover:text-purple-300 transition-colors" />
                </button>
              </div>
            </div>
          </div>
