...
import { Github, ExternalLink, Code, Star, Eye, Calendar } from 'lucide-react';
...
const projects = [
	{
		...
		description:
			'A full-stack e-commerce platform with payment integration, real-time inventory management, and admin dashboard. Features include user authentication, shopping cart, order tracking, and responsive design.',
	...
	},
	{
		...
		description:
			'A collaborative task management application with real-time updates, drag-and-drop functionality, team collaboration features, and advanced filtering options.',
	...
	},
	{
		...
		description:
			'A comprehensive weather analytics dashboard with interactive charts, location-based forecasts, historical data analysis, and customizable alerts.',
	...
	},
	{
		...
		description:
			'An intelligent chat application powered by AI with natural language processing, context awareness, and multi-language support. Built with modern chat UI patterns.',
	...
	},
	{
		...
		title: 'Portfolio CMS',
		description:
			'A headless CMS built specifically for portfolio websites with drag-and-drop page builder, SEO optimization, and performance analytics.',
	...
	},
	{
		...
		description:
			'A React Native mobile application for fitness tracking with workout plans, progress monitoring, social features, and integration with wearable devices.',
...
const Projects = () => {
	...
	return (
		<section
			id="projects"
			className="py-24 bg-black relative font-mono font-roboto"
		>
			<div className="max-w-7xl mx-auto px-6 relative z-10 font-mono font-roboto">
				...
				<div className="flex flex-wrap justify-center gap-3 mb-16 font-mono font-roboto">
					{categories.map((category) => (
						<button
							...
							className={`px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 backdrop-blur-sm font-mono font-roboto ${
								filter === category
				...
				{/* Projects Grid */}
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 font-mono font-roboto">
					{filteredProjects.map((project, index) => (
						<div
							key={project.id}
							className={`group relative font-mono font-roboto ${
						...
						>
							<div className="relative bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/10 hover:border-white/20 transition-all duration-300 hover:bg-white/8 group-hover:scale-[1.02] font-mono font-roboto">
								{/* Featured Badge */}
								{project.featured && (
									<div className="absolute top-4 left-4 z-20 font-mono font-roboto">
										<div className="bg-white text-black px-3 py-1 rounded-full text-xs font-bold flex items-center font-mono font-roboto">
								...
								{/* Status Badge */}
								<div className="absolute top-4 right-4 z-20 font-mono font-roboto">
									<div
										className={`px-3 py-1 rounded-full text-xs font-medium backdrop-blur-sm font-mono font-roboto ${
								...
								{/* Content Section */}
								<div className="p-6 font-mono font-roboto">
									{/* Title and Year */}
									<div className="flex items-start justify-between mb-3 font-mono font-roboto">
										<h3 className="text-xl font-bold text-white group-hover:text-gray-200 transition-colors duration-200 font-mono font-roboto">
											{project.title}
										</h3>
										<span className="text-sm text-gray-400 flex items-center ml-2 font-mono font-roboto">
									...
									{/* Description */}
									<p className="text-gray-400 mb-4 text-sm leading-relaxed line-clamp-3 font-mono font-roboto">
										{project.description}
									</p>

									{/* Tech Stack */}
									<div className="flex flex-wrap gap-2 mb-4 font-mono font-roboto">
										{project.tech.slice(0, 3).map((tech) => (
											<span
												key={tech}
												className={`px-3 py-1 rounded-full text-xs font-medium border backdrop-blur-sm font-mono font-roboto ${getTechColor(
													tech
												)}`}
											>
												{tech}
										...
										{project.tech.length > 3 && (
											<span className="px-3 py-1 bg-white/5 text-gray-400 rounded-full text-xs border border-white/10 font-mono font-roboto">
												+{project.tech.length - 3}
											</span>
										)}
									</div>
									...
									{/* Stats */}
									<div className="flex items-center justify-between pt-4 border-t border-white/10 font-mono font-roboto">
										<div className="flex items-center gap-4 text-sm text-gray-400 font-mono font-roboto">
											<div className="flex items-center font-mono font-roboto">
										...
										<div className="flex items-center gap-3 font-mono font-roboto">
											<a
												...
												target="_blank"
												rel="noopener noreferrer"
												className="text-gray-400 hover:text-gray-200 transition-colors duration-200 font-mono font-roboto"
												title="View Code"
											>
												<Code size={16} />
											</a>
